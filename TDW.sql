...
(1, 'Kalb El Louz', 'Mélangez la semoule, le beurre et le sucre. Bien sabler avec les mains', b'0'),
(2, 'Kalb El Louz', 'Lancez la cuisson du sirop : Dans une grande casserole, mettre l’eau, le sucre . Portez à ébullition pendant 15 minutes', b'0'),
(3, 'Kalb El Louz', 'Beurrez un moule de 24 cm et mettez-y votre', b'0'),
(4, 'Kalb El Louz', 'Découpez à l’aide d’un couteau des carrés ou losanges et Piquez les carrés avec les amandes entières', b'0'),
(5, 'Kalb El Louz', 'Enfournez dans un four préchauffé à 200°c pendant 1 heure, en tournant le plateau de temps en temps', b'0'),
(6, 'Kalb El Louz', 'Dés sa sortie du four, arrosez avec le sirop', b'0'),
(1, 'Ktayef', 'Mélanger les amandes en poudre avec le sucre et un peu d\'eau de fleur d\'oranger', b'0'),
(2, 'Ktayef', 'Badigeonner généreusement de smen fondu le fond d\'un moule rond, pas trop profond', b'0'),
(3, 'Ktayef', 'Ouvrir un peu avec les doigts, les deux boules de ktayef pour les aérer.', b'0'),
(4, 'Ktayef', 'Saupoudrer les amandes en couche sur toute la surface et Arroser d\'eau de fleur d\'oranger, saupoudrer de cannelle et recouvrir avec la seconde couche de ktayef.', b'0'),
(5, 'Ktayef', 'Tasser encore un peu et arranger les bords avant d\'arroser de smen et Mettre au four 5-6 mn pour que la galette se tienne, puis la sortir et la retourner sur une assiette.', b'0'),
(6, 'Ktayef', 'Badigeonner encore une fois le fond du moule', b'0'),
(7, 'Ktayef', 'Remettre au four et laisser cuire, à four moyen. Entre temps, péparer un sirop et Sortir la galette du four quand elle a une jolie couleur dorée', b'0'),
(8, 'Ktayef', 'Remettre au four et laisser cuire, à four moyen. Entre temps, péparer un sirop', b'0'),
(9, 'Ktayef', 'Arroser la galette du mélange sirop/miel et la laisser 1h avant de la retourner. Laisser encore 1h pour qu\'elle s\'imprègne bien de miel, avant de la découper en carrés de la même taille et de la déguster.', b'0'),
(1, 'Baba', 'Préchauffez le four à 170°C', b'0'),
(2, 'Baba', 'Commencez par fouetter le sucre, les oeufs entiers et la vanille avec un batteur, le mélange doit doubler de volume et être bien mousseux', b'0'),
(3, 'Baba', 'Ajoutez l\'huile (ou du beurre fondu) et fouettez encore 1 minute', b'0'),
(4, 'Baba', 'Tamiser la farine, le sel et le levure chimique et mélangez délicatement avec une spatule', b'0'),
(5, 'Baba', 'Versez dans un moule à baba beurré ou dans des moules à muffin pour une version individuelle', b'0'),
(6, 'Baba', 'Enfournez pour 35-40 minutes à 170°C pour la version familiale, et 20 minutes pour les muffins', b'0'),
...
(1, 'Basboussa', 'On commence par préparer le sirop pour avoir le temps de tiédir. Mélanger l\'eau et le sucre dans une casserole, la mettre sur le feu puis laisser frémir une quinzaine de minutes, éteindre le feu pour enfin introduire l\'eau de fleur d\'oranger.', b'0'),
(2, 'Basboussa', 'Dans un saladier mélanger les ingrédients secs, à savoir, farine, semoule, levure, noix de coco et sucre.', b'0'),
(3, 'Basboussa', 'Dans un autre saladier, mélanger les oeufs, le lait et l\'huile, les introduire dans le premier mélange.', b'0'),
(4, 'Basboussa', 'Verser ce mélange dans un plat rectangulaire, le faire cuire au four à 180°C (350° F), la pointe d\'un couteau doit en ressortir sèche.', b'0'),
(5, 'Basboussa', 'Dès sa sortie du four, verser le sirop qui doit être impérativement tiède et laisser le gâteau absorber.', b'0'),
(6, 'Basboussa', 'Laissez le gâteau refroidir avant de le découper sinon il s\'effrite.', b'0'),
(1, 'Cigar', 'Dans un saladier, mélanger les amandes, cannelle, le sucre.', b'0'),
(2, 'Cigar', 'Ajouter l\'eau de fleur d\'oranger et le beurre fondu.', b'0'),
(3, 'Cigar', 'Travailler bien jusqu’à obtenir une pâte maniable.', b'0'),
(4, 'Cigar', 'Prélever de petites boules de pâte d\'amande, les rouler entre les mains pour former un bâtonnet, les déposer dans les feuilles de brick.', b'0'),
(5, 'Cigar', 'Rouler les feuilles de brick pour former des cigares ou façonner des Briouates et Chauffer une petite quantité d\'huile et aussi le miel additionné d\'une c-a-soupe d\'eau de fleur d\'oranger.', b'0'),
(6, 'Cigar', 'Plonger les cigares dans l\'huile chaude jusqu’à obtenir une couleur dorée (les faire dorer de tous les cotés ).', b'0'),
(7, 'Cigar', 'Les égoutter dans une passoire et les plonger dans un miel chauffé.', b'0'),
(1, 'Khobz Touness', 'Commencez par préparer le sirop, faites bouillir le sucre avec l\'eau pendant presque 10 minutes, à la fin de cuisson, ajoutez l\'eau de fleur d\'oranger et retirez du feu..', b'0'),
(2, 'Khobz Touness', 'pour préparer le gâteau, mélangez tous les ingrédients de la pate.', b'0'),
(3, 'Khobz Touness', 'versez la pate dans un moule de presque 30 cm de diamètre, sinon dans des moules individuels', b'0'),
(4, 'Khobz Touness', 'faites cuire dans un four préchauffé à 180 C, jusqu’à ce que le gâteau prenne une belle couleur et que la pointe de couteau insérée dedans ressorte bien sèche', b'0'),
(5, 'Khobz Touness', 'à la sortie du gateau du four, coupez des carrés ou des losanges et arrosez de sirop toujours dans le moule, laissez bien absorber tout le sirop avant de présenter dans des caissettes si vous avez envie.', b'0'),
(1, 'Mhalbi', 'Moulez le riz avec le moulin à café et Versez le lait dans une casserole', b'0'),
(2, 'Mhalbi', 'Ajoutez le sucre et les farines de riz obtenues', b'0'),
(3, 'Mhalbi', 'Mettez sur feu douxMélangez en continu à l\'aide d\'une cuillère en bois, ( une trentaine de minutes à peut près )', b'0'),
(4, 'Mhalbi', 'Retirez du feu et ajoutez la fleur d\'oranger et Mélangez bien', b'0'),
(5, 'Mhalbi', 'Versez la préparation dans des ramequins ou des verrines Lissez la surface à l\'aide du dos d\'une petite cuillère', b'0'),
(1, 'Les Tartelettes', 'Tamisez d’abord la farine dans un grand saladier, ajoutez en dessus le beurre et mélangez le tout à la main pour avoir une chapelure,Ensuite versez en dessus l’eau et mélangez pour avoir une pâte – n’hésitez pas d’ajouter plus d’eau froide.', b'0'),
(2, 'Les Tartelettes', 'Formez une boule avec votre pâte, filmez-la puis mettez-la au frigo pour une durée de 30 minutes', b'0'),
(3, 'Les Tartelettes', 'Faites d’abord chauffer le lait dans une casserole à feu bas – ne pas porter à ébullition,Pendant ce temps fouettez les jaunes d’oeufs avec le sucre dans un saladier puis tamisez en dessus la farine et mélangez le tout', b'0'),
(4, 'Les Tartelettes', 'Après ajoutez le lait chaud lentement au mélange tout en fouettant puis Remettez votre mélange dans la casserole puis portez doucement à ébullition en fouettant continuellement jusqu’à ce qu’il soit épais et crémeux et Retirez la casserole du feu et laissez-la refroidir', b'0'),
(5, 'Les Tartelettes', 'Chauffez votre four à 180° et beurrez vos moules à mini tartes et Farinez un plan de travail, abaissez votre pâte avec le rouleau, étalez-la dans les moules et piquez le fond avec une fourchette', b'0'),
(6, 'Les Tartelettes', 'Ensuite déposez en dessus des morceaux de papier sulfurisé avec un poids – haricots secs – et mettez au four pour 12 minutes', b'0'),
(7, 'Les Tartelettes', 'Après retirez les haricots et le papier sulfurisé puis remettez au four pour une autre cuisson de 12 minutes, jusqu’à ce que la pâte soit dorée.', b'0'),
(8, 'Les Tartelettes', 'Une fois votre pâte est cuite laissez-les refroidir complètement.et remplissez-les avec la crème pâtissière et lissez la surface avec une cuillère ou une spatule.', b'0'),
(9, 'Les Tartelettes', 'Ensuite disposez en dessus votre sélection de tranches de fruits. et Enfin voila votre mini tartelette aux fruits, servez et bon appétit à tous', b'0'),
(1, 'Tiramisu', 'Fouettez vivement 3 jaunes d \'œufs avec le sucre glace jusqu\'à ce que le mélange blanchisse et devienne mousseux.Ajoutez ensuite le mascarpone puis mélangez jusqu \'à ce que le résultat soit bien homogène.', b'0'),
(2, 'Tiramisu', 'Montez 3 blancs en neige ferme en y ajoutant une pincée de sel,\r\npuis mélangez - les à la crème au mascarpone.Attention,\r\npour garder un mélange bien mousseux et léger,\r\nles blancs ne doivent pas être \"cassés\".Mélangez délicatement de haut en bas avec une spatule en silicone en tournant votre récipient d \'un quart de tour à chaque fois.', b'0'),
...
(4, 'Tiramisu', 'Coupez le bout des biscuits afin qu \'ils adhèrent parfaitement à la paroi de votre plat. Utilisez les bouts pour compléter les trous au centre de votre tiramisu. Étalez une couche de crème au mascarpone au fond du plat, puis placez une couche de biscuits légèrement imbibés de café à l\' Amaretto.', b'0'),
(1, 'Zlabia', 'Mélanger la farine et la levure, puis verser l\'eau et bien mélanger de nouveau pour obtenir une pâte lisse. Filmer cette pâte au contact et la laisser reposer au frais pendant 1 h.Retirer délicatement le film, puis mélanger l’appareil et ajouter le safran. Remettre ensuite un film au contact et laisser de nouveau reposer durant 1 h', b'0'),
(2, 'Zlabia', 'Mettre l\'eau et le sucre à bouillir dans une casserole, puis cuire pendant 5 min. Ajouter ensuite le miel et l\'eau de fleur d\'oranger, puis laisser tiédir.', b'0'),
(3, 'Zlabia', 'Préchauffer une friteuse à 180 °C.\r\nRetirer le film de la pâte et placer celle-ci dans une poche à douille. Former ensuite des spirales de pâte (en partant de l’extérieur) directement dans l\'huile chaude et les laisser cuire jusqu\'à obtenir une légère coloration. Égoutter les zlabias sur une plaque garnie de papier absorbant, puis les plonger dans le sirop tiède et les déposer sur une petite grille.', b'0'),
(1, 'Batata Flieu', 'Dans un fait-tout, faites chauffer l’huile et l’ail écrasé, rajoutez les pommes de terre épluchées et coupées en quartiers ou en rondelles.Ajoutez le paprika, le poivre, salez.', b'1'),
(2, 'Batata Flieu', 'Incorporez la moitié du pouliot haché ou laissez les feuilles entières (selon goût) et faites revenir quelques instants jusqu’à ce que les pommes de terre commencent à romollir.', b'1'),
(3, 'Batata Flieu', 'Arrosez d’eau (pas trop car à la fin la sauce doit être réduite) et laissez cuire à couvert.Juste avant la fin de cuisson, introduisez le reste de pouliot.Récupérez une louche de sauce, laissez refroidir.', b'1'),
(4, 'Batata Flieu', 'Dès que le plat est prêt diluez le jaune d’oeuf dans la louche de sauce refroidie, versez sur les pommes de terre.Remuer et cuire encore quelques secondes et ce afin de lier la sauce, mais vous pouvez ne pas le rajouter et servir ainsi vos pommes de terre.', b'1'),
(1, 'Chakchouka', 'Émincer l\'oignon et écraser l\'ail au presse ail. Faire cuire 15 minutes avec l\'huile et une cuillère à soupe d\'eau.', b'1'),
(2, 'Chakchouka', 'Plonger les tomates dans une casserole d\'eau bouillante pendant 15 secondes et les sortir. Les éplucher, les couper en 6 et retirer la pulpe.', b'1'),
(3, 'Chakchouka', 'Éplucher les poivrons en les plaçant 15 minutes sous le grill du four. Les nettoyer et les couper en petites lamelles.', b'1'),
(4, 'Chakchouka', 'Ajouter les tomates et les poivrons dans la cocotte, saler et poivrer. Laisser mijoter environ 30 minutes.', b'1'),
(5, 'Chakchouka', 'Au moment de servir, casser les oeufs sur les légumes et laisser cuire quelques minutes.', b'1'),
(1, 'Gratin Courgette', 'Lavez les courgettes sans les éplucher.Essuyez - les et coupez - les en rondelles de 1 cm ou en gros cubes.', b'1'),
(2, 'Gratin Courgette', 'Faites - les cuire 15 à 18 minutes dans 3 litres d \'eau bouillante salée. Égouttez dans une passoire et pressez-les avec une écumoire pour extraire le trop plein d\' eau.', b'1'),
(3, 'Gratin Courgette', 'Versez les courgettes dans un plat à gratin beurré.Hachez - les grossièrement à la fourchette.', b'1'),
(4, 'Gratin Courgette', 'Dans un saladier,battez les oeufs en omelette,ajoutez la crème,le gruyère râpé,le sel,le poivre et saupoudrez de muscade râpée.', b'1'),
(1, 'Hamama', 'Piler les fleurs de lavande et les feuilles des  autres herbes, bien lavez. Égoutter les de leur eau, et passer au mixeur.', b'1'),
(2, 'Hamama', 'Mettre dans une bassine, couvrir d\'eau, et laisser infuser toutes la nuit. Au matin presser les herbe. Réserver l\'eau.', b'1'),
(3, 'Hamama', 'Dans une Djefna mettre une quantité de semoule, ajouter une poignée du mélange herbes et commencer à rouler pour former les petites graines du couscous, mouiller un peu avec l\'eau réserver.', b'1'),
(4, 'Hamama', 'Passer une première fois au tamis  2-3 mm de diamètre.', b'1'),
(5, 'Hamama', 'Frotter les graines du couscous avec les deux paumes de la mains, passer une 2ème fois dans un tamis, diamètre plus petits, Réserver de coté.', b'1'),
(6, 'Hamama', 'recommencer les opérations 3-4-5 jusqu\'à épuisement de la semoule et des herbes. huiler à l\'huile.', b'1'),
(7, 'Hamama', 'remplir le bas du couscoussier (kadra) avec l\'eau réserver,  mettre sur le feu, à ébullition, mettre le couscoussier rempli de couscous au dessus et faire cuire à la vapeur. Recommencer 4 fois l\'opération.', b'1'),
(8, 'Hamama', 'Une fois terminer, huiler à l\'huile et servie avec du sucre cristallisé, sucre glace, du lait caillé ou du petit lait.', b'1'),
(1, 'Makaroun bel turk', 'Faire cuire les pâtes dans de l\'eau salée, égoutter, rincer a l\'eau froide puis égoutter a nouveau.', b'0'),
(2, 'Makaroun bel turk', 'Faire revenir l\'oignon émincé dans l\'huile. Ajouter la viande hachée. Assaisonner et laisser cuire.', b'0'),
(3, 'Makaroun bel turk', 'Préparer une omelettes avec les oeufs , puis couper-la en petit morceaux.', b'0'),
(4, 'Makaroun bel turk', 'Ajouter l\'omelette sur la viande et incorporer les pâtes.', b'0');
