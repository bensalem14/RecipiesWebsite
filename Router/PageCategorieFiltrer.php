...
$control->showFilterd($x,[$_POST['mintcuisson'],$_POST['maxtcuisson'],$_POST['mintpreparation'],$_POST['maxtpreparation'],$_POST['minttotal'],$_POST['maxttotal'],$_POST['minnotation'],$_POST['maxnotation'],$_POST['mincalorie'],$_POST['maxcalorie'],$saison]);
